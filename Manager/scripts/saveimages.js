            ...
            $element.find('img').not('#divCb img').each(function () {
                ...
                if (jQuery(this).attr('src').indexOf('base64') != -1) {
                    ...
                    if (jQuery('#form' + count).length == 0) {
                        ...
                        '<input id="caminho-' + count + '" name="caminho-' + count + '" type="hidden" value="' + caminho + '" />' +
                        '<input id="caminho_virtual-' + count + '" name="caminho_virtual-' + count + '" type="hidden" value="' + caminho_virtual + '" />' +
