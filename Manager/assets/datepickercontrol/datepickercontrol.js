...
DatePickerControl.editIdPrefix = "cphConteudoHome_DPC_";          // The prefix for edit's id
...
DatePickerControl.createButton = function (input, useId) {
	...
	*/
	...
	calButton.src = "/atualizadxp/Manager/assets/datepickercontrol/calendar_icon.png";
	if (this.buttonPosition == "in") {
