...
var data_basic = {
    'snippets': [
		...
		{
		    'thumbnail': 'preview/text_input.png',
		    'category': '122',
		    'html':
				'<div data-dynamic-node="" class="row clearfix">' +
					'<div class="column full sky-form">' +
						'<section>' +
							'<button type="button" class="close nao_mostra_site" onclick="dynamicForm_config_open(this, \'input\');"><i class="fa fa-cog"></i></button>' +
							'<label class="label">Text input</label>' +
							'<label class="input">' +
								'<input type="text" data-dynamic-field="input" data-dynamic-field-name="" />' +
							'</label>' +
						'</section>' +
					'</div>' +
				'</div>'
		...
		{
		    'thumbnail': 'preview/file_input.png',
		    'category': '122',
		    'html':
				'<div data-dynamic-node="" class="row clearfix">' +
					'<div class="column full sky-form">' +
						'<section>' +
							'<button type="button" class="close nao_mostra_site" onclick="dynamicForm_config_open(this, \'input_file\');"><i class="fa fa-cog"></i></button>' +
							'<label class="label">File input</label>' +
							'<label for="file" class="input input-file">' +
								'<div class="button"><input type="file" id="file" data-dynamic-field="input_file" data-dynamic-field-name="" onchange="this.parentNode.nextSibling.value = this.value">Carregar Arquivo</div><input type="text" readonly=""  />' +
							'</label>' +
						'</section>' +
					'</div>' +
				'</div>'
		...
		{
		    'thumbnail': 'preview/select_input.png',
		    'category': '122',
		    'html':
				'<div data-dynamic-node="" class="row clearfix">' +
					'<div class="column full sky-form">' +
						'<section>' +
							'<button type="button" class="close nao_mostra_site" onclick="dynamicForm_config_open(this, \'select\');"><i class="fa fa-cog"></i></button>' +
							'<label class="label">Select</label>' +
							'<label class="select">' +
								'<select data-dynamic-field="select" data-dynamic-field-name="">' +
								'</select>' +
								'<i></i>' +
							'</label>' +
						'</section>' +
		...
		{
		    'thumbnail': 'preview/text_radio.png',
		    'category': '122',
		    'html':
				'<div data-dynamic-node="" class="row clearfix">' +
					'<div class="column full sky-form">' +
						'<button type="button" class="close nao_mostra_site" onclick="dynamicForm_config_open(this, \'radio\');"><i class="fa fa-cog"></i></button>' +
						'<label class="radio">' +
							'<input type="radio" data-dynamic-field="radio" data-dynamic-field-name="" />' +
							'<i></i>' +
							'Opção de Radio' +
						'</label>' +
					'</div>' +
		...
		{
		    'thumbnail': 'preview/text_checkbox.png',
		    'category': '122',
		    'html':
				'<div data-dynamic-node="" class="row clearfix">' +
					'<div class="column full sky-form">' +
						'<button type="button" class="close nao_mostra_site" onclick="dynamicForm_config_open(this, \'checkbox\');"><i class="fa fa-cog"></i></button>' +
						'<label class="checkbox">' +
							'<input type="checkbox" data-dynamic-field="checkbox" data-dynamic-field-name="" />' +
							'<i></i>' +
							'Opção de Checkbox' +
						'</label>' +
					'</div>' +
		...
		{
		    'thumbnail': 'preview/textarea.png',
		    'category': '122',
		    'html':
				'<div data-dynamic-node="" class="row clearfix">' +
					'<div class="column full sky-form">' +
						'<button type="button" class="close nao_mostra_site" onclick="dynamicForm_config_open(this, \'textarea\');"><i class="fa fa-cog"></i></button>' +
						'<label class="label">Textarea</label>' +
						'<label class="textarea">' +
							'<textarea rows="3" data-dynamic-field="textarea" data-dynamic-field-name=""></textarea>' +
						'</label>' +
					'</div>' +
				'</div>'
		},
		{
		    'thumbnail': 'preview/enviar_input.png',
		    'category': '122',
		    'html':
				'<div data-dynamic-node="" class="row clearfix">' +
					'<div class="column full sky-form">' +
						'<div>' +
							'<button type="submit" data-dynamic-button="submit" class="btn btn-primary">Enviar</button>' +
						'</div>' +
					'</div>' +
				'</div>'
		},
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column full">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/oleg-laptev-545268-unsplash-VD7ll2.jpg" alt="">' +
					'</div>' +
				'</div>'
		},
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/jon-lalin-731093-unsplash-(1)-tdmMt1.jpg" alt="">' +
					'</div>' +
					'<div class="column half">' +
						'<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>' +
					'</div>' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/adam-birkett-209727-unsplash-(2)-H2BMm1.jpg" alt="">' +
					'</div>' +
				'</div>'
		},
		{
		...
		'html':
				'<div class="embed-responsive embed-responsive-16by9">' +
            		'<iframe width="560" height="315" class="img-responsive" src="//www.youtube.com/embed/P5yHEKqx86U?rel=0" frameborder="0" allowfullscreen=""></iframe>' +
            	'</div>'
        },
		...
		'html':
			    '<div class="embed-responsive embed-responsive-16by9">' +
            		'<iframe width="100%" height="400" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" class="mg1" class="img-responsive" src="https://maps.google.com/maps?q=Melbourne,+Victoria,+Australia&amp;hl=en&amp;sll=-7.981898,112.626504&amp;sspn=0.009084,0.016512&amp;oq=melbourne&amp;hnear=Melbourne+Victoria,+Australia&amp;t=m&amp;z=10&amp;output=embed"></iframe>' +
            	'</div>'
        },
			    ...
			    '<div class="row clearfix">' +
                    '<div class="column full" data-noedit data-module="slider" data-module-desc="Slider" data-html="' +
                        ...
                        encodeURIComponent('<div id="{id}" class="slider-on-content" style="width:100%;height:500px;display:none">' +
                            '<div class="is-boxes slider-image" style="background-image: url(\'/' + pasta_inicial + 'assets/minimalist-blocks/images/slide1.jpg\');">' +
                            '</div>' +
                            '<div class="is-boxes slider-image" style="background-image: url(\'/' + pasta_inicial + 'assets/minimalist-blocks/images/slide2.jpg\');">' +
                            '</div>' +
                            '<div class="is-boxes slider-image" style="background-image: url(\'/' + pasta_inicial + 'assets/minimalist-blocks/images/slide3.jpg\');">' +
                            '</div>' +
                        '</div>' +
                        '' +
                        '<scr' + 'ipt>' +
                        ...
                        encodeURIComponent('[' +
                                '{' +
                                    ...
                                    '"images":' +
                                        '[' +
                                            '{' +
                                                '"src": "' + pasta_inicial + 'assets/minimalist-blocks/images/slide1.jpg", ' +
                                                '"caption": "", "link": "", "width": "450", "align": "", "position": "bottom left"' +
                                            '},' +
                                            '{' +
                                                '"src": "' + pasta_inicial + 'assets/minimalist-blocks/images/slide2.jpg", ' +
                                                '"caption": "", "link": "", "width": "450", "align": "", "position": "bottom left"' +
                                            '},' +
                                            '{' +
                                                '"src": "' + pasta_inicial + 'assets/minimalist-blocks/images/slide3.jpg", ' +
                                                '"caption": "", "link": "", "width": "450", "align": "", "position": "bottom left"' +
                                            '}' +
                                        ']' +
                                '}]') + '"' +
                            ...
                            '<div data-glide-el="track" class="glide__track">' +
                                '<ul class="glide__slides">' +
                                    '<li class="glide__slide">' +
                                        '<div data-subblock><img data-image-embed data-noresize data-sync class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/slide2.jpg" alt="" /></div>' +
                                        '<div class="is-slider-caption" style="left:4vw;bottom:4vw">Lorem Ipsum</div>' +
                                    '</li>' +
                                    '<li class="glide__slide">' +
                                        '<div data-subblock><img data-image-embed data-noresize data-sync class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/slide3.jpg" alt="" /></div>' +
                                    '</li>' +
                                '</ul>' +
                            '</div>' +
                            '' +
		...
		'html':
				'<div class="row clearfix">' +
                    '<div class="column half">' +
                        '<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/jon-lalin-731093-unsplash-(1)-tdmMt1.jpg" alt="" style="margin: 0;float: left;">' +
                    '</div>' +
                    '<div class="column half">' +
                        '<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/adam-birkett-209727-unsplash-(2)-H2BMm1.jpg" alt="" style="margin: 0;float: left;">' +
                    '</div>' +
                '</div>'
},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
                    '<div class="column third">' +
                        '<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/chuttersnap-413002-unsplash-83HqE1.jpg" alt="" style="margin: 0;float: left;">' +
                    '</div>' +
                    '<div class="column third">' +
                        '<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/caroline-bertolini-270870-unsplash-1j5FB2.jpg" alt="" style="margin: 0;float: left;">' +
                    '</div>' +
                    '<div class="column third">' +
                        '<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/theo-roland-740436-unsplash-WqnWJ3.jpg" alt="" style="margin: 0;float: left;">' +
                    '</div>' +
                '</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
                    '<div class="column full">' +
                        '<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/oleg-laptev-545268-unsplash-VD7ll2.jpg" alt="" style="margin: 0;float: left;">' +
                    '</div>' +
                '</div>'
		},
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/pawel-czerwinski-1080345-unsplash-Zxz1W1.jpg" alt="">' +
						'\n<h3 class="size-21">IMAGE CAPTION</h3>' +
						'\n<p style="color: rgb(158, 158, 158);">Lorem Ipsum is simply dummy text</p>' +
					'</div>' +
					'<div class="column half center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/agata-create-1137058-unsplash-(1)-UvBs02.jpg" alt="">' +
						'\n<h3 class="size-21">IMAGE CAPTION</h3>' +
						'\n<p style="color: rgb(158, 158, 158);">Lorem Ipsum is simply dummy text</p>' +
					'</div>' +
				'</div>'
        ...
        
		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/monika-grabkowska-742426-unsplash-AtCtH1.jpg" alt="">' +
						'\n<h3 class="size-18">CAPTION</h3>' +
						'\n<p class="size-14" style="color: rgb(136, 136, 136);">Lorem Ipsum is dummy text.</p>' +
					'</div>' +
					'<div class="column third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/mira-bozhko-456995-YiVKC1.jpg" alt="">' +
						'\n<h3 class="size-18">CAPTION</h3>' +
						'\n<p class="size-14" style="color: rgb(136, 136, 136);">Lorem Ipsum is dummy text.</p>' +
					'</div>' +
					'<div class="column third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/lauren-mancke-63448-unsplash-AtCtH2.jpg" alt="">' +
						'\n<h3 class="size-18">CAPTION</h3>' +
						'\n<p class="size-14" style="color: rgb(136, 136, 136);">Lorem Ipsum is dummy text.</p>' +
					'</div>' +
				'</div>'
        ...
        
		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/susanne-schwarz-1142929-unsplash-IZGK11.jpg" alt="">' +
						'\n<h3 class="size-21">IMAGE CAPTION</h3>' +
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third center">' +
                        ...
                        '<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/art-materials-close-up-color-pencils-1484263-jT5E21.jpg" alt="">' +
                        '</div>' +
                        '\n<p class="size-14">Lorem Ipsum is dummy text</p>' +
					'</div>' +
					'<div class="column third center">' +
                        '<div class="img-circular">' +
                        '<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/oleg-laptev-546607-unsplash-SKGb82.jpg" alt="">' +
						'</div>' +
                        '\n<p class="size-14">Lorem Ipsum is dummy text</p>' +
					'</div>' +
					'<div class="column third center">' +
                        '<div class="img-circular">' +
                        '<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/michal-grosicki-XG2yA3.jpg" alt="">' +
						'</div>' +
                        '\n<p class="size-14">Lorem Ipsum is dummy text</p>' +
					'</div>' +
				'</div>'
        ...
        
		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/remi-muller-359340-unsplash-JOL3q1.jpg" alt="">' +
						'\n<p><i>Lorem Ipsum is dummy text</i></p>' +
					'</div>' +
					'<div class="column half center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/dlanor-s-591314-unsplash-maNC32.jpg" alt="">' +
						'\n<p><i>Lorem Ipsum is dummy text</i></p>' +
					'</div>' +
				'</div>'
		},
        
		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/agata-create-1132088-unsplash-(1)-adQTO1.jpg" alt="">' +
						'\n<p>IMAGE CAPTION</p>' +
					'</div>' +
					'<div class="column third center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/lucrezia-carnelos-1127196-unsplash-Y7ahO2.jpg" alt="">' +
						'\n<p>IMAGE CAPTION</p>' +
					'</div>' +
					'<div class="column third center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/bright-bulb-close-up-1166643-oof1G3.jpg" alt="">' +
						'\n<p>IMAGE CAPTION</p>' +
					'</div>' +
				'</div>'
		},
        
		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/omar-lopez-32084-8ciiC1.jpg" alt="">' +
        ...
        
		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-ORebV1.jpg" alt="">' +
					'</div>' +
					'<div class="column third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/ian-dooley-298771-unsplash-Hu2RU3.jpg" alt="">' +
					'</div>' +
					'<div class="column third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/daniel-klopper-1142809-unsplash-pToHm2.jpg" alt="">' +
					'</div>' +
				'</div>'
		},
        
		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column full">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/anthony-tran-1076077-vcoLP1.jpg" alt="">' +
					'</div>' +
				'</div>'
		},
        
		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column two-third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/rawpixel-1200191-unsplash-Ms1O81.jpg" alt="">' +
					'</div>' +
					'<div class="column third">' +
        ...
        
		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column two-third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/iman-soleimany-zadeh-1205567-unsplash-AUqMZ2.jpg" alt="">' +
					'</div>' +
				'</div>'
		},
        
		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/maksym-zakharyak-688728-unsplash-p9w092.jpg" alt="">' +
					'</div>' +
					'<div class="column half">' +
						'<div class="spacer height-60"></div>' +
        ...
        
		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/rodion-kutsaev-24833-unsplash-HEuVp1.jpg" alt="">' +
					'</div>' +
				'</div>'
		},
        
		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column two-third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/monica-galentino-102655-unsplash-gfbdC1.jpg" alt="">' +
					'</div>' +
					'<div class="column third">' +
        ...
        
		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column two-third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/rawpixel-1197453-unsplash-a7ozj2.jpg" alt="">' +
					'</div>' +
				'</div>'
		},
        
		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-XstZ21.jpg" alt="">' +
						'\n<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-budQW2.jpg" alt="">' +
					'</div>' +
					'<div class="column half">' +
        ...
        
		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/sarah-dorweiler-211779-unsplash-dN96G1.jpg" alt="">' +
						'\n<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/kris-atomic-39874-unsplash-vpMhe2.jpg" alt="">' +
					'</div>' +
				'</div>'
		},
        
		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/rawpixel-1197458-unsplash-J52N31.jpg" alt="">' +
					'</div>' +
        ...
        
		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-5F3zm1.jpg" alt="">' +
					'</div>' +
				'</div>'
		},
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<div style="padding-right:30px">' +
							_tabs(1) + '<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-4r9Fa1.jpg" alt="">' +
						'\n</div>' +
					'</div>' +
					'<div class="column half">' +
						'<div class="spacer height-80"></div>' +
				...
				'<div class="row clearfix">' +
					...
					'<div class="column half">' +
						'<div style="padding-left:30px">' +
							_tabs(1) + '<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-lbizY1.jpg" alt="">' +
						'\n</div>' +
					'</div>' +
				'</div>'
		},
        
		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-ocaLR1.jpg" alt="">' +
					'</div>' +
					'<div class="column half">' +
						'<div class="spacer height-40"></div>' +
				...
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-mHAa32.jpg" alt="">' +
					'</div>' +
				'</div>'
		},
        
		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column two-third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-OJKzv1.jpg" alt="">' +
					'</div>' +
					'<div class="column third">' +
        ...
        
		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column two-third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-I81sR1.jpg" alt="">' +
					'</div>' +
				'</div>'
		},
		    ...
		    'html':
		    	'<div class="row clearfix">' +
		    		'<div class="center column half">' +
		    			'<div class="img-circular" style="width:270px;height:270px"><img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/raychan-1667344-unsplash-5M5cC1.jpg" alt=""></div>' +
					'</div>' +
					'<div class="column half">' +
		...
		
		{
		    ...
		    'html':
		    	'<div class="row clearfix">' +
					...
					'</div>' +
		    		'<div class="center column half">' +
		    			'<div class="img-circular" style="width:270px;height:270px"><img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/kris-atomic-39874-unsplash-(1)-by2om1.jpg" alt=""></div>' +
					'</div>' +
				'</div>'
		},
		    	...
		    	'<div class="row clearfix">' +
					'<div class="column half">' +
						'<div style="text-align: center;">' +
							_tabs(1) + '<div class="img-circular" style="width:270px;height:270px"><img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/vashishtha-jogi-101218-unsplash-(1)-qLaZ61.jpg" alt=""></div>' +
							_tabs(1) + '<div class="spacer height-20"></div>' +
					...
					'<div class="column half">' +
						'<div style="text-align: center;">' +
							_tabs(1) + '<div class="img-circular" style="width:270px;height:270px"><img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/karl-jk-hedin-614069-unsplash-wq2fh2.jpg" alt=""></div>' +
							_tabs(1) + '<div class="spacer height-20"></div>' +
							_tabs(1) + '<h3 class="size-21" style="letter-spacing: 1px;">IMAGE CAPTION</h3>' +
							_tabs(1) + '<p>Lorem Ipsum is simply dummy text of the printing industry</p>' +
						'\n</div>' +
		...
		
		{
		    ...
		    'html':
		    	'<div class="row clearfix">' +
		    		'<div class="column half center">' +
		    			'<div class="img-circular" style="margin:25px 0;width:270px;height:270px"><img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/mae-mu-1634728-unsplash-YfIdG1.jpg" alt=""></div>' +
		    		'</div>' +
		    		'<div class="column half">' +
		    			'<div class="spacer height-20"></div>' +
		    	...
		    	'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half center">' +
						'<div class="img-circular" style="margin:25px 0;width:270px;height:270px"><img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/mae-mu-1675094-unsplash-mIDqg2.jpg" alt=""></div>' +
					'</div>' +
				'</div>'
		},
		    ...
		    'html':
		    	'<div class="row clearfix">' +
		    		'<div class="column two-fourth">' +
		    			'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/inside-weather-dbh_vy7vice-unsplash-DALMx1.jpg" alt="">' +
		    		'</div>' +
		...
		
		{
		    ...
		    'html':
		    	'<div class="row clearfix">' +
					...
					'</div>' +
		    		'<div class="column two-fourth">' +
		    			'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/inside-weather-bayizhkkjm4-unsplash-VhybU2.jpg" alt="">' +
		    		'</div>' +
		    	'</div>'
		},
		
		{
		    ...
		    'html':
		    	'<div class="row clearfix">' +
		    		'<div class="column third">' +
		    			'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/phil-desforges-kp7p0-drgbg-unsplash-uoCld1.jpg" alt="">' +
		    			'\n<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/carl-revell-woxtqpbubpu-unsplash-qDOYv1.jpg" alt="">' +
		    		'</div>' +
		    		'<div class="column third">' +
		    			'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/bibarys-ibatolla-xotjdtjyfws-unsplash-qDOYv2.jpg" alt="">' +
		    			'\n<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/bruno-abatti-xzer0sqkpee-unsplash-rfD4g3.jpg" alt="">' +
		    		'</div>' +
		    		'<div class="column third">' +
		...
		
		{
		    ...
		    'html':
		    	'<div class="row clearfix">' +
		    		...
		    		'</div>' +
		    		'<div class="column third">' +
		    			'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/kelly-sikkema-mdadgzyxcve-unsplash-HLpZE1.jpg" alt="">' +
		    			'\n<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/drew-patrick-miller-15omq1s9de0-unsplash-mWuF91.jpg" alt="">' +
		    		'</div>' +
		    		'<div class="column third">' +
		    			'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/fabrice-villard-du41jiai5ww-unsplash-RmVMS2.jpg" alt="">' +
		    			'\n<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/yusuf-evli-djqx057gbc0-unsplash-Vx3x11.jpg" alt="">' +
		    		'</div>' +
		    	'</div>'
		},
		
		{
		    ...
		    'html':
		    	...
		    	'<div class="row clearfix">' +
		    		'<div class="column third">' +
		    			'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/ruben-bagues-vpqfc4nidh0-unsplash-9uqtu2.jpg" alt="">' +
						'\n<p style="text-align: center; color: rgb(149, 149, 149);margin-top:0">Image Caption</p>' +
					'</div>' +
					'<div class="column third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/mitch-lensink-hx_dy7xeszo-unsplash-xpg6d1.jpg" alt="">' +
						'\n<p style="text-align: center; color: rgb(149, 149, 149);margin-top:0">Image Caption</p>' +
					'</div>' +
					'<div class="column third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-IlCYO1.jpg" alt="">' +
						'\n<p style="text-align: center; color: rgb(149, 149, 149);margin-top:0">Image Caption</p>' +
					'</div>' +
		    	'</div>' +
		    	'<div class="row clearfix">' +
		    		'<div class="column third">' +
		    			'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/annie-spratt-e82beol6l2y-unsplash-eItnZ2.jpg" alt="">' +
						'\n<p style="text-align: center; color: rgb(149, 149, 149);margin-top:0">Image Caption</p>' +
					'</div>' +
					'<div class="column third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/davide-ragusa-atutapqj4zw-unsplash-sQQiM1.jpg" alt="">' +
						'\n<p style="text-align: center; color: rgb(149, 149, 149);margin-top:0">Image Caption</p>' +
					'</div>' +
					'<div class="column third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/julie-kwak-fry-tptmjrk-unsplash-3Rlxu2.jpg" alt="">' +
						'\n<p style="text-align: center; color: rgb(149, 149, 149);margin-top:0">Image Caption</p>' +
					'</div>' +
		    	'</div>'
		},
		
		{
		    ...
		    'html':
		    	...
		    	'<div class="row clearfix">' +
		    		'<div class="column half">' +
		    			'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/silvia-agrasar-227575-21Sbp1.jpg" alt="">' +
		    			'\n<p style="color: rgb(149, 149, 149);">Lorem Ipsum is simply dummy text of the printing industry.</p>' +
		    		'</div>' +
		    		'<div class="column half">' +
		    			'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/silvia-agrasar-227135-unsplash-EPxWp2.jpg" alt="">' +
		    			'\n<p style="color: rgb(149, 149, 149);">Lorem Ipsum is simply dummy text of the printing industry.</p>' +
		    		'</div>' +
		    	'</div>'
		},
		
		{
		    ...
		    'html':
		    	...
		    	'<div class="row clearfix">' +
		    		'<div class="column third">' +
		    			'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/snapbythree-my-yif5f2kao_y-unsplash-2G89F1.jpg" alt="">' +
		    		'</div>' +
		    		'<div class="column two-third">' +
		    	...
		    	'<div class="row clearfix">' +
		    		...
		    		'</div>' +
		    		'<div class="column third">' +
		    			'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/daniel-schludi-mbgxz7pt0jm-unsplash-2G89F2.jpg" alt="">' +
		    		'</div>' +
		    	'</div>'
		},
		
		{
		    ...
		    'html':
		    	...
		    	'<div class="row clearfix">' +
		    		'<div class="column third">' +
		    			'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/luke-southern-hyvittjtkpi-unsplash-tXBIU1.jpg" alt="">' +
		    		'</div>' +
		    		'<div class="column third">' +
		    			'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/luke-southern-k5o-cuu9e6g-unsplash-zop4J2.jpg" alt="">' +
		    		'</div>' +
		    		'<div class="column third">' +
		    			'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/liliana-olivares-g56o5l0zvmg-unsplash-yieQU3.jpg" alt="">' +
		    		'</div>' +
		    	'</div>'
		},
		
		{
		    ...
		    'html':
		    	'<div class="row clearfix">' +
		    		'<div class="column half">' +
		    			'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/herdian-indraputra-6knvj1fr3ug-unsplash-3aMS13.jpg" alt="">' +
		    			'\n<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>' +
		    		'</div>' +
		    		'<div class="column half">' +
		    			'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/yi-sk-u7yek0lrzmg-unsplash-KNpU64.jpg" alt="">' +
		    			'\n<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>' +
		    		'</div>' +
		    	'</div>'
		},
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third center">' +
						'<div class="img-circular"><img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/bangkit-ristant-395541-e0mhz1.jpg" alt=""></div>' +
						'\n<h3 class="size-21" style="letter-spacing: 2px;">VINCENT NELSON</h3>' +
						'\n<p style="color: #b7b7b7">WEB DESIGNER</p>' +
					'</div>' +
					'<div class="column third center">' +
						'<div class="img-circular"><img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/redd-angelo-427759-33bDf2.jpg" alt=""></div>' +
						'\n<h3 class="size-21" style="letter-spacing: 2px;">NATHAN WILLIAMS</h3>' +
						'\n<p style="color: #b7b7b7">WEB DEVELOPER</p>' +
					'</div>' +
					'<div class="column third center">' +
						'<div class="img-circular"><img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/mads-schmidt-rasmussen-186319-8AVbA1.jpg" alt=""></div>' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/samuel-zeller-413072-Tx4ai1.jpg" alt="">' +
					...
					'</div>' +
					'<div class="column third center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/michael-236683-Tx4ai2.jpg" alt="">' +
					...
					'</div>' +
					'<div class="column third center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/michael-221247-Hspxi3.jpg" alt="">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/working-2618559_1920-kr4Af1.jpg" alt="">' +
						'\n<h3 class="size-21" style="letter-spacing: 2px;">Sarah Doe</h3>' +
						'\n<p style="color: rgb(136, 136, 136);">Founder</p>' +
					'</div>' +
					'<div class="column third center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/rawpixel-632454-unsplash-ecHZN1.jpg" alt="">' +
						'\n<h3 class="size-21" style="letter-spacing: 2px;">David Anderson</h3>' +
						'\n<p style="color: rgb(136, 136, 136);">Programmer</p>' +
					'</div>' +
					'<div class="column third center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/girl-2618562_1920-KAzoZ2.jpg" alt="">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/luke-ellis-craven-365822-wrHAg1.jpg" alt="">' +
					...
					'</div>' +
					'<div class="column third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/yoann-boyer-276971-S8TZu2.jpg" alt="">' +
						'\n<h5 class="size-21" style="letter-spacing: 2px;">Sarah Smith <span style="color: rgb(136, 136, 136);">/ Developer</span></h5>' +
						'\n<p>Lorem Ipsum is dummy text of the printing and typesetting industry.</p>' +
					'</div>' +
					'<div class="column third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/pablo-hermoso-429590-(1)-fP4pI3.jpg" alt="">' +
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column fourth center">' +
						'<div class="img-circular" style="width:150px;height:150px;"><img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/adult-1868750_1920-EzivE1.jpg" alt=""></div>' +
						'\n<h3 class="size-21">David Smith</h3>' +
						'\n<p class="size-14" style="color: rgb(136, 136, 136);">CEO & Founder</p>' +
					'</div>' +
					'<div class="column fourth center">' +
						'<div class="img-circular" style="width:150px;height:150px;"><img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/noah-buscher-502067-(1)-rT7Vn1.jpg" alt=""></div>' +
						'\n<h3 class="size-21">Milla Clarke</h3>' +
						'\n<p class="size-14" style="color: rgb(136, 136, 136);">Project Manager</p>' +
					'</div>' +
					'<div class="column fourth center">' +
						'<div class="img-circular" style="width:150px;height:150px;"><img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/berwin-coroza-495276-tXRrf2.jpg" alt=""></div>' +
						'\n<h3 class="size-21">John Rugg</h3>' +
						'\n<p class="size-14" style="color: rgb(136, 136, 136);">Developer</p>' +
					'</div>' +
					'<div class="column fourth center">' +
						'<div class="img-circular" style="width:150px;height:150px;"><img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/mark-skeet-537093-6gF113.jpg" alt=""></div>' +
       ...
       
		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/girl-690119-c7s4t1.jpg" alt="">' +
					'</div>' +
					'<div class="column half">' +
						'<h2>Your Name</h2>' +
						'\n<p>Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>' +
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/photo-1437915160026-6c59da36ede2-AakHA2.jpg" alt="">' +
					'</div>' +
					'<div class="column half">' +
						'<h2>Your Name</h2>' +
						'\n<p>Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>' +
				...
				'<div class="row clearfix">' +
					'<div class="column third">' +
						'<div class="is-card max-390 is-light-text" style="width:calc(100%);background: #1c93ad;">' +
							_tabs(1) + '<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/bernard-osei-608155-unsplash-BsEPC1.jpg" alt="" class="margin-0">' +
					...
					'<div class="column third">' +
						'<div class="is-card max-390 is-light-text" style="width:calc(100%);background: #e0527e;">' +
							_tabs(1) + '<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-HAWqm1.jpg" alt="" class="margin-0">' +
							_tabs(1) + '<div style="padding:25px;width:100%;box-sizing:border-box;text-align:center;">' +
					...
					'<div class="column third">' +
						'<div class="is-card max-390 is-light-text" style="width:calc(100%);background: #e17055">' +
							_tabs(1) + '<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/girl-from-behind-1741699-(1)-PqduN2.jpg" alt="" class="margin-0">' +
							_tabs(1) + '<div style="padding:25px;width:100%;box-sizing:border-box;text-align:center;">' +
      ...
      
		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third center">' +
						'<div class="img-circular" style="width:150px;height:150px;"><img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/rawpixel-632454-unsplash-oLoHS1.jpg" alt=""></div>' +
					...
					'</div>' +
					'<div class="column third center">' +
						'<div class="img-circular" style="width:150px;height:150px;"><img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-tfqUv1.jpg" alt=""></div>' +
					...
					'</div>' +
					'<div class="column third center">' +
						'<div class="img-circular" style="width:150px;height:150px;"><img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/rawpixel-1054600-unsplash-PylVl2.jpg" alt=""></div>' +
      ...
      
		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/sarah-noltner-687653-unsplash-6Agfw1.jpg" alt="">' +
					'</div>' +
					'<div class="column half">' +
      ...
      
		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half center">' +
						'<div class="img-circular" style="width:270px;height:270px;"><img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/luke-porter-520986-unsplash-kjuDr1.jpg" alt=""></div>' +
					'</div>' +
					'<div class="column half">' +
      ...
      
		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half center">' +
						'<div class="img-circular" style="width:270px;height:270px;"><img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/nicole-honeywill-546846-unsplash-(1)-84PNj2.jpg" alt=""></div>' +
					'</div>' +
					'<div class="column half">' +
				...
				'<div class="row clearfix">' +
					'<div class="column half center">' +
						'<div class="img-circular" style="width:270px;height:270px;"><img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/alex-iby-480498-unsplash-JOL3q3.jpg" alt=""></div>' +
					'</div>' +
					'<div class="column half">' +
      ...
      
		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/nordwood-themes-166423-unsplash-(1)-4WJ2H1.jpg" alt="">' +
					...
					'</div>' +
					'<div class="column half center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-9Htn91.jpg" alt="">' +
      ...
      
		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/parker-johnson-1100877-unsplash-(1)-rufBy1.jpg" alt="">' +
					'</div>' +
					'<div class="column half">' +
				...
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/beautiful-close-up-color-1078058-Qywhs1.jpg" alt="">' +
					'</div>' +
				'</div>'
		},
      
		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/daniel-apodaca-584113-unsplash-(1)-U9Iby1.jpg" alt="">' +
					'</div>' +
				'</div>'
		},
      
		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half center">' +
						'<div class="img-circular" style="width:270px;height:270px;"><img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/alex-shaw-1116446-unsplash-JWfd61.jpg" alt=""></div>' +
					...
					'</div>' +
					'<div class="column half center">' +
						'<div class="img-circular" style="width:270px;height:270px;"><img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-JMXQP1.jpg" alt=""></div>' +
      ...
      
		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half center">' +
						'<div class="img-circular" style="width:270px;height:270px;"><img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/simon-migaj-775713-unsplash-l8oSx1.jpg" alt=""></div>' +
					'</div>' +
				'</div>'
		},
		
		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-6Q6W91.jpg" alt="">' +
					'</div>' +
					'<div class="column half">' +
						'<div class="spacer height-80"></div>' +
		...
		
		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-ayzzH2.jpg" alt="">' +
					'</div>' +
				'</div>'
		},
		
		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-fxBmr1.jpg" alt="">' +
					'</div>' +
					'<div class="column half">' +
		...
		
		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-6SDpQ1.jpg" alt="">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-z01lr1.jpg" alt="">' +
					'</div>' +
					'<div class="column half">' +
		...
		
		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-SRJrq2.jpg" alt="">' +
					'</div>' +
				'</div>'
		},
		
		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-otLsK1.jpg" alt="">' +
					'</div>' +
					'<div class="column half">' +
		...
		
		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-TUrpQ1.jpg" alt="">' +
					'</div>' +
				'</div>'
		},

        {
            ...
            'html':
				'<div class="row clearfix">' +
					'<div class="column third center">' +
						'<div class="img-circular" style="margin:15px 0;width:140px;height:140px;"><img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-DbQGW1.jpg" alt=""></div>' +
					'</div>' +
					'<div class="column two-third">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column third center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-gs7XT1.jpg" alt="">' +
					'</div>' +
					'<div class="column two-third">' +
		...
		
		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half center">' +
						'<div class="img-circular" style="margin:30px 0;width:270px;height:270px;"><img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-DjWQ71.jpg" alt=""></div>' +
					'</div>' +
					'<div class="column half">' +
						'<div style="padding-left:40px">' +
		...
		
		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half center">' +
						'<div class="img-circular" style="margin:30px 0;width:270px;height:270px;"><img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-c2y4f1.jpg" alt=""></div>' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/florian-van-duyn-b66ga6c48he-unsplash-UHsG01.jpg" alt="">' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/felipe-giacometti-4i5topi4k_c-unsplash-uRiHa1.jpg" alt="">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/ellieelien-y_zbw7s2x3s-unsplash-7fXG32.jpg" alt="">' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/genevieve-rusnac-uv_qxy6hseo-unsplash-qSqg21.jpg" alt="">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column two-third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/martin-katler-y15xwiek6ba-unsplash-pWD4T1.jpg" alt="">' +
					'</div>' +
				'</div>'
		},
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column full">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/group-of-people-standing-indoors-3184396-cBo871.jpg" alt="">' +
					'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
					'<div class="column full">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/bogomil-mihaylov-irbdbd6h_v8-unsplash-yXHmD1.jpg" alt="">' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column full">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/four-people-sitting-beside-wooden-table-3184327-iEien1.jpg" alt="">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/mae-mu-1533437-unsplash-Ti0dU2.jpg" alt="">' +
					'</div>' +
					'<div class="column third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/agata-create-4sbdro9nd5c-unsplash-Ti0dU1.jpg" alt="">' +
					'</div>' +
				'</div>'
		},
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/william-daigneault-dmycyllkazq-unsplash-pyPYL1.jpg" alt="">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/jack-l-smith-ziustaoqndc-unsplash-ToAnR1.jpg" alt="">' +
					'</div>' +
					'<div class="column half">' +
						'<p style="text-align: justify;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type.</p>' +
					'</div>' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column full">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/erik-mclean-tn6xocyjy5u-unsplash-0uMCW1.jpg" alt="">' +
					'</div>	' +
				'</div>'
		},

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/sitepro.png" alt="" style="margin: 0;">' +
					'</div>' +
					'<div class="column two-third">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/photo-1459411552884-841db9b3cc2a-YO89Y1.jpg" alt="">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/photo-1471256737566-c7ddd846bee0-small-NBNfZ2.jpg" alt="">' +
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third center">' +
						'<div class="is-card is-dark-text shadow-1" style="width:calc(100%);">' +
							_tabs(1) + '<div style="padding:25px;width:100%;box-sizing:border-box;">' +
								_tabs(2) + '<div class="img-circular"><img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/x98sw2520-sh1J31.jpg" alt=""></div>' +
					...
					'<div class="column third center">' +
						'<div class="is-card is-dark-text shadow-1" style="width:calc(100%);">' +
							_tabs(1) + '<div style="padding:25px;width:100%;box-sizing:border-box;">' +
								_tabs(2) + '<div class="img-circular"><img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/georgie-cobbs-467923-unsplash-G9q9p2.jpg" alt=""></div>' +
					...
					'<div class="column third center">' +
						'<div class="is-card is-dark-text shadow-1" style="width:calc(100%);">' +
							_tabs(1) + '<div style="padding:25px;width:100%;box-sizing:border-box;">' +
								_tabs(2) + '<div class="img-circular"><img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/martin-widenka-555176-unsplash-sh1J33.jpg" alt=""></div>' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-7eFyL1.jpg" alt="">' +
						'\n<h3 class="size-21">PRODUCT NAME</h3>' +
						'\n<p>Lorem Ipsum is simply dummy text of the printing industry.</p>' +
						'\n<p><a href="#">BUY NOW</a></p>' +
					'</div>' +
					'<div class="column third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-09yZA2.jpg" alt="">' +
						'\n<h3 class="size-21">PRODUCT NAME</h3>' +
						'\n<p>Lorem Ipsum is simply dummy text of the printing industry.</p>' +
						'\n<p><a href="#">BUY NOW</a></p>' +
					'</div>' +
					'<div class="column third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-Tmg8p2.jpg" alt="">' +
						'\n<h3 class="size-21">PRODUCT NAME</h3>' +
						'\n<p>Lorem Ipsum is simply dummy text of the printing industry.</p>' +
						'\n<p><a href="#">BUY NOW</a></p>' +
					'</div>' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/h-e-n-g-s-t-r-e-a-m-573432-unsplash-xt89A1.jpg" alt="">' +
					...
					'</div>' +
					'<div class="column third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/sarah-dorweiler-357724-unsplash-4cfGV2.jpg" alt="">' +
						'\n<h3 class="size-18" style="font-weight: 400;">PRODUCT NAME, <span style="color: rgb(136, 136, 136);">$79</span></h3>' +
						'\n<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>' +
						'\n<p><a href="#" title="">BUY NOW</a></p>' +
					'</div>' +
					'<div class="column third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/michael-frattaroli-234662-unsplash-QaduA1.jpg" alt="">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-5v3uL1.jpg" alt="">' +
					'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-C3XHH1.jpg" alt="">' +
					'</div>' +
					'<div class="column half">' +
						'<div style="padding-left: 40px">' +
							_tabs(1) + '<h1 class="size-42">Product Name</h1>' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column fourth center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-7Vn0R1.jpg" alt="">' +
					...
					'</div>' +
					'<div class="column fourth center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/nordwood-themes-473050-jFvLM1.jpg" alt="">' +
						'\n<p style="color: rgb(136, 136, 136); font-weight: normal;">' +
							_tabs(1) + 'PRODUCT NAME' +
							_tabs(1) + '<br>' +
					...
					'</div>' +
					'<div class="column fourth center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/toa-heftiba-448302-(1)-pXDhf1.jpg" alt="">' +
						'\n<p style="color: rgb(136, 136, 136); font-weight: normal;">' +
							_tabs(1) + 'PRODUCT NAME' +
							_tabs(1) + '<br>' +
					...
					'</div>' +
					'<div class="column fourth center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-p8OMT2.jpg" alt="">' +
						'\n<p style="color: rgb(136, 136, 136); font-weight: normal;">' +
							_tabs(1) + 'PRODUCT NAME' +
							_tabs(1) + '<br>' +
							_tabs(1) + '<a href="#" title="">$99</a>' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/gaelle-marcel-jdxgmqjt1lu-unsplash-0N9uW1.jpg" alt="">' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +	
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/irene-kredenets-8j4diaobamo-unsplash-(1)-7VV9f2.jpg" alt="">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/luke-southern-r1opyghnbd4-unsplash-MljtW1.jpg" alt="">' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +	
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/wooden-chair-qTO5r1.jpg" alt="">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/mitch-lensink-588486-unsplash-GDz4y1.jpg" alt="">' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/christelle-bourgeois-97314-unsplash-p3tmH2.jpg" alt="">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/adam-birkett-6cxznfcd2kq-unsplash-lqmrN1.jpg" alt="">' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/plush-design-studio-777289-unsplash-tlEBZ1.jpg" alt="">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/daniel-fontenele-s4kvecxgcdo-unsplash-2XhGF1.jpg" alt="">' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/kara-eads-cxew49dylf4-unsplash-Ej12x2.jpg" alt="">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column two-third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/barrett-ward-p44rigl9v54-unsplash-vNiki1.jpg" alt="">' +
					'</div>' +
					'<div class="column third">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column two-third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/swabdesign_official-nfkmjfxhqgc-unsplash-KsRhW2.jpg" alt="">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/irene-kredenets-1690829-unsplash-qmqP41.jpg" alt="">' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/irene-kredenets-1686187-unsplash-CU0Rc2.jpg" alt="">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column two-third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/shop-slo-hkxuhdsbezy-unsplash-CdqN81.jpg" alt="">' +
					'</div>' +
					'<div class="column third">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column two-third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/content-pixie-6cfcrt-7thw-unsplash-pDbf91.jpg" alt="">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/michael-frattaroli-207278-unsplash-3XV7F1.jpg" alt="">' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/rocknwool-ujaxqq0tb5a-unsplash-khITm1.jpg" alt="">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/sincerely-media-tw917xag0wu-unsplash-c1cdS1.jpg" alt="">' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/daniil-silantev-1p6ankdw6s8-unsplash-O6mXc2.jpg" alt="">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/pizza-3000285_1920-0ccra1.jpg" alt="">' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/sina-piryae-6xmqv6gccyu-unsplash-5lXVR1.jpg" alt="">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/eiliv-sonas-aceron-0gq8fh1f54k-unsplash-cql6u1.jpg" alt="">' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/karly-gomez-lk1q5ryd6tc-unsplash-16U971.jpg" alt="">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/charles-deluvio-271645-unsplash-pNDz81.jpg" alt="">' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/charles-wr8ze_o-sji-unsplash-YyDs11.jpg" alt="">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/carly-jayne-2vgufemdhem-unsplash-VOUIN1.jpg" alt="">' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/mariana-medvedeva-nm1fz-scxne-unsplash-T9wXJ1.jpg" alt="">' +
					'</div>' +
				'</div>'
		},
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/imac-Bz83W1.png" alt="">' +
					'</div>' +
					'<div class="column half">' +
						'<div class="list">' +
							_tabs(1) + '<i class="icon ion-checkmark"></i>' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/kara-michelle-544960-zjkQn1.jpg" alt="">' +
					'</div>' +
					'<div class="column third">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/aidan-hancock-440776-unsplash-8u7fo1.jpg" alt="">' +
					'</div>' +
					'<div class="column third">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/workplace-1245776_1280-oxBIU1.jpg" alt="">' +
					'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/desk-office-hero-workspace-(1)-V8F292.jpg" alt="">' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-BwYjC1.jpg" alt=""></div>' +
					'</div>' +
				'<div class="row clearfix">' +
					'<div class="column full">' +
						'<div class="spacer height-40"></div>' +
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-FrSUb2.jpg" alt="">' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third">' +
						'<div style="padding-right:30px">' +
							_tabs(1) + '<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-sGkY41.jpg" alt="">' +
						'\n</div>' +
					'</div>' +
					'<div class="column third">' +
...

        {
            ...
            'html':
		    	...
		    	'<div class="row clearfix">' +
		    		'<div class="column half center">' +
		    			'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-F0dm51.jpg" alt="">' +
					...
					'</div>' +
					'<div class="column half center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-x5GRp1.jpg" alt="">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-S0R1k1.jpg" alt="">' +
						'\n<p>Lorem Ipsum is simply dummy text of the printing industry. — Nelson Sand</p>' +
					'</div>' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-QqxYJ2.jpg" alt="">' +
...

		{
		    ...
		    'html':
		    	'<div class="row clearfix">' +
		    		'<div class="column third center">' +
		    			'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-F6TCZ1.jpg" alt="">' +
		    		'</div>' +
		    		'<div class="column two-third">' +
...

		{
		    ...
		    'html':
		    	'<div class="row clearfix">' +
		    		'<div class="column third center">' +
		    			'<div class="img-circular" style="margin:15px 0;width:170px;height:170px;"><img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-Q1XSO1.jpg" alt=""></div>' +
		    		'</div>' +
		    		'<div class="column two-third">' +
		    			'<div style="margin-top:10px"><i class="icon ion-quote size-24" style="color: #888888"></i></div>' +
						'\n<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>' +
...

		{
		    ...
		    'html':
		    	...
		    	'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-akB4h1.jpg" alt="">' +
					'</div>' +
					'<div class="column half">' +
						'<div class="quote">' +
							_tabs(1) + '<i class="icon ion-quote"></i>' +
				...
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-R79NY2.jpg" alt="">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
		    	...
		    	'<div class="row clearfix">' +
					'<div class="column half center">' +
						'<div class="img-circular" style="margin:15px 0;width:270px;height:270px;"><img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-ybeSl1.jpg" alt=""></div>' +
					'</div>' +
					'<div class="column half">' +
						'<div class="quote">' +
							_tabs(1) + '<i class="icon ion-quote"></i>' +
				...
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<div class="img-circular" style="margin:15px 0;width:270px;height:270px;"><img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-KUCDN4.jpg" alt=""></div>' +
					'</div>' +
				'</div>'
		},
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/watch-1663246_1920-8wuCM1.jpg" alt="">' +
						'\n<div class="spacer height-20"></div>' +
					...
					'</div>' +
					'<div class="column third center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-frUlS1.jpg" alt="">' +
						'\n<div class="spacer height-20"></div>' +
						'\n<i class="icon ion-quote size-24"></i>' +
						'\n<p>Lorem Ipsum is simply dummy text of the printing industry.</p>' +
						'\n<p class="size-14">by Your Name</p>' +
					'</div>' +
					'<div class="column third center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-RXypm2.jpg" alt="">' +
						'\n<div class="spacer height-20"></div>' +
						'\n<i class="icon ion-quote size-24"></i>' +
						'\n<p>Lorem Ipsum is simply dummy text of the printing industry.</p>' +
						'\n<p class="size-14">by Your Name</p>' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third center">' +
						'<div class="img-circular"><img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/noah-buscher-548633-ExLNF1.jpg" alt=""></div>' +
					...
					'</div>' +
					'<div class="column third center">' +
						'<div class="img-circular"><img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/icons8-team-355990-Voloz1.jpg" alt=""></div>' +
						'\n<p style="color: #bdc3c7"><i class="icon ion-android-hangout size-32"></i></p>' +
						'\n<p class="size-16">Lorem Ipsum is simply dummy text of the printing industry. — Clara Wang</p>' +
					'</div>' +
					'<div class="column third center">' +
						'<div class="img-circular"><img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/pexels-photo-girl-zZWwv1.jpg" alt=""></div>' +
						'\n<p style="color: #bdc3c7"><i class="icon ion-android-hangout size-32"></i></p>' +
...

		{
		    ...
		    'html':
		    	'<div class="row clearfix">' +
		    		'<div class="column half">' +
		    			'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-6PDKL1.jpg" alt="">' +
		    		'</div>' +
		    		'<div class="column half">' +
...

		{
		    ...
		    'html':
		    	'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-OWu2H1.jpg" alt="">' +
					'</div>' +
				'</div>'
		},
		    ...
		    'html':
		    	'<div class="row clearfix">' +
		    		'<div class="column center full">' +
		    			'<div class="img-circular" style="width:150px;height:150px;"><img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-TK4An1.jpg" alt=""></div>' +
		    		'</div>' +
		    	'</div>' +
		    	'<div class="row clearfix">' +
		    		'<div class="column center full">' +
...

		{
		    ...
		    'html':
		    	'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column two-third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/inside-weather-ybg3jopjas0-unsplash-tDa7p1.jpg" alt="">' +
					'</div>' +
		    	'</div>'
		},

		{
		    ...
		    'html':
		    	'<div class="row clearfix">' +
					'<div class="column two-third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/marek-levak-gnvxujz_cxu-unsplash-ga0Rb1.jpg" alt="">' +
					'</div>' +
		    		'<div class="column third">' +
		    			'<h3 class="size-24">"It\'s easy to use and customizable. A truly amazing features with reasonable prices."</h3>' +
						'\n<div class="spacer height-20"></div>' +
...

		{
		    ...
		    'html':
		    	'<div class="row clearfix">' +
		    		'<div class="column full">' +
						'<div style="text-align: center;">' +
							'<div class="img-circular" style="width:270px;height:270px;"><img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/alice-achterhof-4klszvmanme-unsplash-onIRm1.jpg" alt=""></div>' +
							'<h3>Mary Andrews</h3>' +
...

		{
		    ...
		    'html':
		    	'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/yang-deng-ydeiwoqhsps-unsplash-A62nL1.jpg" alt="">' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
		    	'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/jason-blackeye-gdrspeeq7ry-unsplash-IP5Da2.jpg" alt="">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
		    	'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/sincerely-media-zfs8v4ujxa4-unsplash-QuMOb1.jpg" alt="">' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
		    	'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/marten-bjork-707746-unsplash-r5u0H1.jpg" alt="">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
		    	'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/woman-with-blonde-hair-wearing-blue-3283576-xmKhr2.jpg" alt="" style="margin: 0">' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
		    	'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/person-holding-a-big-leaf-covering-his-face-3094224-TL0km3.jpg" alt="" style="margin:0">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
		    	'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/woman-wearing-red-beret-and-gray-long-sleeve-dress-with-wild-3518091-(1)-P27XS1.jpg" alt="">' +
					'</div>' +
					'<div class="column half">' +
						'<div class="spacer height-120"></div>' +
...

		{
		    ...
		    'html':
		    	'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/the-bialons-n1hdyt_uyxa-unsplash-20c8T1.jpg" alt="">' +
					'</div>' +
				'</div>'
		},
...

		{
		    ...
		    'html':
		    	'<div class="row clearfix center">' +
					'<div class="column half">' +
						'<div class="img-circular" style="margin:20px 0;width:270px;height:270px;"><img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/spencer-davis-bqgq2qd3mty-unsplash-CSt9i2.jpg" alt=""></div>' +
					'</div>' +
					'<div class="column half">' +
						'<div class="spacer height-40"></div>' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half center">' +
						'<div class="img-circular" style="margin:20px 0;width:270px;height:270px;"><img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/photo-1549235377-962f47f40409-wcrYL1.jpg" alt=""></div>' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
		    	'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/man-using-black-camera-3136161-u9GRr1.jpg" alt="">' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
		    	'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/photo-of-man-covering-his-face-with-leaf-3754279-OCoFs1.jpg" alt="">' +
					'</div>' +
				'</div>'
		},
...

		{
			...
			'html':
				...
				'<div class="row clearfix">' +
					'<div class="column fourth center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/creative.png" alt="">' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/light-studio.png" alt="">' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/infinitech.png" alt="">' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/design-firm.png" alt="">' +
					'</div>' +
				'</div>'
		},
				...
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<div class="center" style="display:inline-block;width:18%">' +
							'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/sitepro.png" alt="">' +
						'</div>' +
						'<div class="center" style="display:inline-block;width:18%">' +
							'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/steady.png" alt="">' +
						'</div>' +
						'<div class="center" style="display:inline-block;width:18%">' +
							'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/creative.png" alt="">' +
						'</div>' +
		    ...
		    'html':
					...
					'<div class="column third">' +
						'<div class="is-card is-dark-text shadow-1" style="width:calc(100%);">' +
							_tabs(1) + '<div style="padding:10px;width:100%;box-sizing:border-box;text-align:center;">' +
								_tabs(2) + '<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/creative.png" alt="">' +
							_tabs(1) + '</div>' +
						'\n</div>' +
					'</div>' +
					'<div class="column third">' +
						'<div class="is-card is-dark-text shadow-1" style="width:calc(100%);">' +
							_tabs(1) + '<div style="padding:10px;width:100%;box-sizing:border-box;text-align:center;">' +
								_tabs(2) + '<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/steady.png" alt="">' +
							_tabs(1) + '</div>' +
						'\n</div>' +
					'</div>' +
					'<div class="column third">' +
						'<div class="is-card is-dark-text shadow-1" style="width:calc(100%);">' +
							_tabs(1) + '<div style="padding:10px;width:100%;box-sizing:border-box;text-align:center;">' +
								_tabs(2) + '<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/infinitech.png" alt="">' +
							_tabs(1) + '</div>' +
						'\n</div>' +
					'</div>' +
				'</div>' +
				...
				'<div class="row clearfix">' +
					'<div class="column third">' +
						'<div class="is-card is-dark-text shadow-1" style="width:calc(100%);">' +
							_tabs(1) + '<div style="padding:10px;width:100%;box-sizing:border-box;text-align:center;">' +
								_tabs(2) + '<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/light-studio.png" alt="">' +
							_tabs(1) + '</div>' +
						'\n</div>' +
					'</div>' +
					'<div class="column third">' +
						'<div class="is-card is-dark-text shadow-1" style="width:calc(100%);">' +
							_tabs(1) + '<div style="padding:10px;width:100%;box-sizing:border-box;text-align:center;">' +
								_tabs(2) + '<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/design-firm.png" alt="">' +
							_tabs(1) + '</div>' +
						'\n</div>' +
					'</div>' +
					'<div class="column third">' +
						'<div class="is-card is-dark-text shadow-1" style="width:calc(100%);">' +
							_tabs(1) + '<div style="padding:10px;width:100%;box-sizing:border-box;text-align:center;">' +
								_tabs(2) + '<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/sitepro.png" alt="">' +
							_tabs(1) + '</div>' +
						'\n</div>' +
					'</div>' +
				'</div>'
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column fourth">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/worldwide.png" alt="">' +
					'</div>' +
					'<div class="column fourth">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/steady.png" alt="">' +
					'</div>' +
					...
					'</div>' +
					'<div class="column fourth">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/upclick.png" alt="">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column fourth center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/creative.png" alt="" style="margin: 0">' +
						'\n<hr style="border-top: 1px solid #919191;width: 30px;display: inline-block;margin: 0;">' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/infinitech.png" alt="" style="margin:0">' +
						'\n<hr style="border-top: 1px solid #919191;width: 30px;display: inline-block;margin: 0;">' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/light-studio.png" alt="" style="margin:0">' +
						'\n<hr style="border-top: 1px solid #919191;width: 30px;display: inline-block; margin: 0;">' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/sitepro.png" alt="" style="margin:0">' +
				...
				'<div class="row clearfix">' +
					'<div class="column fourth center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/worldwide.png" alt="" style="margin:0">' +
						'\n<hr style="border-top: 1px solid #919191;width: 30px;display: inline-block;margin: 0;">' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/steady.png" alt="" style="margin: 0">' +
						'\n<hr style="border-top: 1px solid #919191;width: 30px;display: inline-block;margin: 0;">' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/upclick.png" alt="" style="margin:0">' +
						'\n<hr style="border-top: 1px solid #919191;width: 30px;display: inline-block;margin: 0;">' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/design-firm.png" alt="" style="margin:0">' +
						'\n<hr style="border-top: 1px solid #919191;width: 30px;display: inline-block; margin: 0;">' +
					'</div>' +
				'</div>'
		},
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/bbuzz.png" alt="" style="margin: 0;">' +
					'</div>' +
					'<div class="column third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/sitepro.png" alt="" style="margin: 0;">' +
					'</div>' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<div class="center" style="display:inline-block;width:18%">' +
							_tabs(1) + '<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/sitepro.png" alt="">' +
						'\n</div>' +
						'\n<div class="center" style="display:inline-block;width:18%">' +
							_tabs(1) + '<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/steady.png" alt="">' +
						'\n</div>' +
						'\n<div class="center" style="display:inline-block;width:18%">' +
							_tabs(1) + '<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/creative.png" alt="">' +
						'\n</div>' +
						'\n<div class="center" style="display:inline-block;width:18%">' +
							_tabs(1) + '<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/light-studio.png" alt="">' +
						'\n</div>' +
						'\n<div class="center" style="display:inline-block;width:18%">' +
							_tabs(1) + '<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/infinitech.png" alt="">' +
						'\n</div>' +
					'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<div class="center" style="display:inline-block;width:18%">' +
							_tabs(1) + '<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/design-firm.png" alt="">' +
						'\n</div>' +
						'\n<div class="center" style="display:inline-block;width:18%">' +
							_tabs(1) + '<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/bbuzz.png" alt="">' +
						'\n</div>' +
						'\n<div class="center" style="display:inline-block;width:18%">' +
							_tabs(1) + '<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/upclick.png" alt="">' +
						'\n</div>' +
						'\n<div class="center" style="display:inline-block;width:18%">' +
							_tabs(1) + '<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/onesight.png" alt="">' +
						'\n</div>' +
						'\n<div class="center" style="display:inline-block;width:18%">' +
							_tabs(1) + '<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/worldwide.png" alt="">' +
						'\n</div>' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column fourth center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/onesight.png" alt="">' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/mmedia.png" alt="">' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/digitalmag.png" alt="">' +
					'</div>' +
				'</div>'
		},
       ...
       
		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column fourth center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/bbuzz.png" alt="">' +
					'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
					'<div class="column fourth center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/prosource.png" alt="">' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/light-studio.png" alt="">' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/nett.png" alt="">' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/worldwide.png" alt="">' +
					'</div>' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<div class="center" style="display:inline-block;width:18%">' +
							_tabs(1) + '<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/prosource.png" alt="">' +
						'\n</div>' +
						'\n<div class="center" style="display:inline-block;width:18%">' +
							_tabs(1) + '<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/mmedia.png" alt="">' +
						'\n</div>' +
						'\n<div class="center" style="display:inline-block;width:18%">' +
							_tabs(1) + '<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/bbuzz.png" alt="">' +
						'\n</div>' +
				...
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<div class="center" style="display:inline-block;width:18%">' +
							_tabs(1) + '<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/digitalmag.png" alt="">' +
						'\n</div>' +
						'\n<div class="center" style="display:inline-block;width:18%">' +
							_tabs(1) + '<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/upclick.png" alt="">' +
						'\n</div>' +
						'\n<div class="center" style="display:inline-block;width:18%">' +
							_tabs(1) + '<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/nett.png" alt="">' +
						'\n</div>' +
						'\n<div class="center" style="display:inline-block;width:18%">' +
							_tabs(1) + '<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/creative.png" alt="">' +
						'\n</div>' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column fourth center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/mmedia.png" alt="" style="margin: 0">' +
						'\n<hr style="border-top: 1px solid #919191;width: 30px;display: inline-block;margin: 0;">' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/bbuzz.png" alt="" style="margin:0">' +
					...
					'</div>' +
					'<div class="column fourth center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/digitalmag.png" alt="" style="margin:0">' +
						'\n<hr style="border-top: 1px solid #919191;width: 30px;display: inline-block;margin: 0;">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/onesight.png" alt="" style="margin: 0;">' +
					'</div>' +
					'<div class="column third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/prosource.png" alt="" style="margin: 0;">' +
					'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
					'<div class="column full">' +
				...
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/nett.png" alt="" style="margin: 0;">' +
					'</div>' +
					'<div class="column third">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/digitalmag.png" alt="" style="margin: 0;">' +
					'</div>' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/lost-2747289-ThbrT1.png" alt="">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<div class="embed-responsive embed-responsive-16by9">' +
							_tabs(1) + '<iframe width="100%" height="400" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" class="mg1" class="img-responsive" src="https://maps.google.com/maps?q=Melbourne,+Victoria,+Australia&amp;hl=en&amp;sll=-7.981898,112.626504&amp;sspn=0.009084,0.016512&amp;oq=melbourne&amp;hnear=Melbourne+Victoria,+Australia&amp;t=m&amp;z=10&amp;output=embed"></iframe>' +
						'\n</div>' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/-5TpV91.jpg" alt="">' +
					'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
					'<div class="column full center">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<div class="embed-responsive embed-responsive-16by9" style="height:360px"><iframe width="100%" height="400" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" class="mg1" class="img-responsive" src="https://maps.google.com/maps?q=Melbourne,+Victoria,+Australia&amp;hl=en&amp;sll=-7.981898,112.626504&amp;sspn=0.009084,0.016512&amp;oq=melbourne&amp;hnear=Melbourne+Victoria,+Australia&amp;t=m&amp;z=10&amp;output=embed"></iframe></div>' +
					'</div>' +
				'</div>'
		},
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/annie-spratt-sbdwf4-rlmu-unsplash-XD22V1.jpg" alt="">' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img class="img-responsive" src="' + pasta_inicial + 'assets/minimalist-blocks/images/callum-shaw-1s2rgks4wbm-unsplash-2evzt1.jpg" alt="">' +
					'</div>' +
				'</div>'
		},
