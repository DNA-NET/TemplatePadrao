<?php
/*
	Copyright (c) 2010, 2011 Conselho Regional de Contabilidade do Paraná - http://www.fccr.org.br
...
class DbMSSQL {
	...
	*/
	...
	{
		try {
			$r = mssql_fetch_assoc($_queryResult);
	...
	*/
	...
	{
		try {
			return mssql_query($_query, $this->connectionId);
		} catch (Exception $e) {
			echo "ERRO: " .$e->getMessage();
			return NULL;
		}
	...
	*/
	...
	{
		try {
			return mssql_num_rows($_queryResult);
		} catch (Exception $e) {
			echo "ERRO: " .$e->getMessage();
			return NULL;
		}
